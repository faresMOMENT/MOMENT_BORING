(() => {
  const loadingTimer=setTimeout(()=>document.body?.classList.add('moment-loading-visible'),180);
  ...
  nav.addEventListener('click',event=>{
    ...
    closeMenu();
    document.body.classList.add('moment-page-loading');
    document.body.setAttribute('aria-busy','true');
    setTimeout(()=>location.href=destination.href,35);
  });
  ...
  clearTimeout(loadingTimer);document.body.classList.remove('moment-page-loading','moment-loading-visible');document.body.classList.add('moment-page-ready');document.body.removeAttribute('aria-busy');
  };
